...
// Basic types for language server functionality
interface Position {
    line: number;
    character: number;
}
...
class LqlLanguageServer {
    ...
    // Format document
    formatDocument(document: TextDocument): { range: Range; newText: string }[] {
...
export const lqlLanguageServer = new LqlLanguageServer();
